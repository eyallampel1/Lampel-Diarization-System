...
%SPHRHARM  forward and inverse spherical harmionic transforms
%
% If f(e,a) is a complex-valued function defined on the surface of the
% sphere (0<=e<=pi, 0<=a<2pi), then we can approximate it using complex
% spherical harmonics as f(e,a) = sum(F(n,m)*u(n,m,e,a)) where the sum
...
%     (2) Spherical harmonics: y=sphrharm('f',x,n)
...
%   (2) the number of points in the inclination grid must, for now, be even if the 'U' option is chosen
...
%      Version: $Id: sphrharm.m,v 1.3 2009/11/27 15:34:33 dmb Exp $
%
