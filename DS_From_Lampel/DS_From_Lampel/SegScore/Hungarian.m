...
%Hungarian    Compute optimal assignment by Munkres algorithm
%		Hungarian(DISTMATRIX) computes the optimal assignment (minimum
...
%
%		[ASSIGNMENT, COST] = Hungarian(DISTMATRIX) returns the
